...
# prepare-deps.sh - Prepare Go dependencies for KrankyBear ThreatInvaders
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}KrankyBear ThreatInvaders - Dependency Setup${NC}"
echo -e "${BLUE}========================================${NC}"
echo ""
...
echo "  make build"
echo "  or"
echo "  go build -mod=vendor -o threatinvaders"
echo ""
